...
return [
        ...
        |--------------------------------------------------------------------------
        |
        | Les lignes suivantes contiennent les messages d’erreur utilisés par le
        | validateur. Vous êtes libre de les modifier selon les besoins de votre
        | application.
        |
        */
        ...
        'ascii' => 'Le champ :attribute ne doit contenir que des caractères alphanumériques ASCII à un octet.',
        ...
        'password' => [
            ...
            'uncompromised' => 'Le :attribute fourni apparaît dans une fuite de données. Veuillez en choisir un autre.',
        ],
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Permet de remplacer :attribute par un nom plus lisible
        | (ex : "Adresse e-mail" au lieu de "email")
        |
        */
