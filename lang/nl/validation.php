...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | De volgende taalregels bevatten foutmeldingen die door de validator worden
    | gebruikt. Je kunt ze aanpassen aan de behoeften van je applicatie.
    |
    */
    ...
    'dimensions' => 'De afbeelding van :attribute heeft ongeldige afmetingen.',
    ...
    'in_array_keys' => 'Het veld :attribute moet minstens een van de volgende sleutels bevatten: :values.',
    ...
    'lte' => [
        ...
        'string' => 'Het veld :attribute moet maximaal :value tekens bevatten.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'Het opgegeven :attribute komt voor in een datalek. Kies een andere.',
    ],
    ...
    'prohibited_if_declined' => 'Het veld :attribute is verboden wanneer :other is geweigerd.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Hiermee kun je :attribute vervangen door een leesbaardere naam
    | (bijv. "E-mailadres" in plaats van "email")
    |
    */
    'attributes' => [],
